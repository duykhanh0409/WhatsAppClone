...
struct MessageItem: Identifiable {
    ...
    static let stubMessages: [MessageItem] = [
        ...
        MessageItem(id: UUID().uuidString, isGroupChat: false, text: "Check out this Photo", type: .photo, ownerUid: "2", timeStamp: Date()),
        MessageItem(id: UUID().uuidString, isGroupChat: true, text: "Play out this Video", type: .video, ownerUid: "5",  timeStamp: Date()),
        MessageItem(id: UUID().uuidString, isGroupChat: true, text: "Audio", type: .audio, ownerUid: "1",  timeStamp: Date())
    ]
}
